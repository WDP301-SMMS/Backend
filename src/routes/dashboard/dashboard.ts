...
router.get('/classes', AdminClassController.getClasses);

router.post('/classes', AdminClassController.createClass);
...
router.delete(
  ...
  AdminPartnerController.removeStaff,
);
router.put(
  '/partners/:partnerId/manager',
  AdminPartnerController.replaceManager,
);

// ROUTE XEM KHO DÀNH CHO ADMIN
router.get('/inventory', AdminInventoryViewerController.getInventoryForAdmin);
