...
const seedDatabase = async () => {
  try {
    ...
    await Promise.all([
      ...
      HealthCheckRecordModel.deleteMany({}),
    ...
    if (!blogAuthor) {
      console.warn(
        'Warning: No manager user found to be the author of blog posts.',
      );
    } else {
      ...
      const blogPosts = [
        {
          ...
          title:
            '5 Lời khuyên để Giữ gìn Sức khỏe cho Học sinh trong Mùa tựu trường',
          coverImageUrl:
            'https://placehold.co/1200x600/DDE3F0/333333?text=Suc+Khoe+Hoc+Duong', // <-- THÊM VÀO ĐÂY
        ...
        },
        {
          ...
          coverImageUrl:
            'https://placehold.co/1200x600/AEC6CF/333333?text=Tiem+Chung', // <-- THÊM VÀO ĐÂY
        ...
        },
        {
          ...
          coverImageUrl:
            'https://placehold.co/1200x600/FFD1DC/333333?text=Benh+Hoc+Duong', // <-- THÊM VÀO ĐÂY
