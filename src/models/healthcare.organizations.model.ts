...
export const OrganizationManager = mongoose.model<IManagerInfo>('OrganizationManager', ManagerInfoSchema);
export const OrganizationStaffs = mongoose.model<IPartnerStaff>('OrganizationStaff', PartnerStaffSchema);